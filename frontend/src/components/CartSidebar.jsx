            ...
            >
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '0 20px 20px', backgroundColor: '#f8f8f8' }}>
                    {cart.length === 0 ? (
                        ...
                        cart.map(item => (
                            <div key={item.cart_item_id} style={{ display: 'flex', gap: '15px', padding: '20px 0', borderBottom: '1px solid #ddd', backgroundColor: '#fff', marginTop: '15px', padding: '15px', borderRadius: '4px' }}>
